...
# Unpack dict into arguments. This is fine, but slightly more confusing. Good when working with variables though.
named(**{"name": "Bob", "age": 25})
...
# You will frequently see things like these in Python code:
